...
# Form implementation generated from reading ui file 'itfAnagramme2.ui'
#
...
class Ui_MainWindow(object):
    ...
    def jeu(self):
        ...
        if self.solution == []:
            ...
            for mot in self.solution:
                self.textBrowser.append('<a href="https://fr.wiktionary.org/wiki/{}">{}</a>'.format(mot, mot))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Pro des Mots Helper"))
        self.pushButton.setText(_translate("MainWindow", "Recherche"))
        self.label.setText(_translate("MainWindow", "Nombre de lettres du tirage :"))
        self.label_2.setText(_translate("MainWindow", "Nombre de résultats trouvés :"))
